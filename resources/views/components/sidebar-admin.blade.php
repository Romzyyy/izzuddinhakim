...
<aside id="default-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <h3 class="text-2xl font-bold text-center dark:text-white py-2">Admin</h3>
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/admin-aboutme"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">About Me</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="/admin-academia"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Academia</span>
                </a>
            </li>
            <li>
