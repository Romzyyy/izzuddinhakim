<x-user-layout>
    <div
        class="p-4 grid grid-cols-1 gap-16 py-2 md:grid-cols-2 bg-white dark:bg-gray-950 transition duration-300 ease-in-out text-gray-900 dark:text-gray-100">
        @foreach ($my_blog_category as $blog)
            <div class="mt-16">
                <p class="text-3xl font-semibold">category name: {{ $blog->category }}</p>
                <div
                    class="md:rounded-lg mt-24 p-6 md:border-b-0 bg-gray-100 shadow-2xl dark:shadow-white/10 dark:bg-gray-900 border-muted-foreground pb-12 md:pb-6 md:pr-6  md:hover:bg-gray-400/10 ">
